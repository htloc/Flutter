...
const String pathObjectDetectionModel = "assets/models/test.torchscript";
const String pathObjectDetectionModelYolov8 =
    "assets/models/test.torchscript";
const String labelPathClassification =
    "assets/labels/label_classification_imageNet.txt";
const String labelPathObjectDetection = "assets/labels/labels.txt";
